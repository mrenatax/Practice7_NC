...
public class Task {
     ...
     */
    public boolean checkTitle(String title) throws NullPointerException {
        if (title.equals("")) {
     ...
     */
    public boolean checkTime(int time) throws ArithmeticException {
        if (time < 0) {
     ...
     */
    public boolean checkTime(int start, int end, int repeat) throws ArithmeticException {
        if (start < 0) {
